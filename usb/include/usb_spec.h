...
#if 1 //nsmoon@191021, FIXME
#define USB_DESCRIPTOR_TYPE_VENDOR (0x24U)
#define USB_DESCRIPTOR_TYPE_VENDOR_REPORT (0x25U)
#define USB_DESCRIPTOR_TYPE_VENDOR_PHYSICAL (0x26U)
#endif
