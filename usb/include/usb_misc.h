...
#define usb_debug(...) //printf(__VA_ARGS__) //nsmoon@201108
#else
#define usb_echo(...)
#define usb_debug(...) //printf(__VA_ARGS__) //nsmoon@201108
#endif
#else
#if (_DEBUG == 1) || defined(DEBUG)
//#define usb_echo(...) DbgConsole_Printf(__VA_ARGS__)
#define usb_echo DbgConsole_Printf 
#define usb_debug(...) //printf(__VA_ARGS__) //nsmoon@201108
#else //nsmoon@190808
#define usb_echo(...)
#define usb_debug(...) //DbgConsole_Printf(__VA_ARGS__) //nsmoon@201108
#endif
#endif
