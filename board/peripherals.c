...
static void BOARD_TMR1_init(void) {
  ...
  QTMR_SetupPwm(BOARD_TMR1_PERIPHERAL, BOARD_TMR1_CHANNEL_0_CHANNEL, 357143UL, 46U, true, BOARD_TMR1_CHANNEL_0_CLOCK_SOURCE);
}
...
static void BOARD_TMR2_init(void) {
  ...
  /* Setup the PWM mode of the timer channel */
  QTMR_SetupPwm(BOARD_TMR2_PERIPHERAL, BOARD_TMR2_CHANNEL_3_CHANNEL, 357143UL, 46U, true, BOARD_TMR2_CHANNEL_3_CLOCK_SOURCE);
}
...
static void BOARD_TMR3_init(void) {
  ...
  /* Setup the PWM mode of the timer channel */
  QTMR_SetupPwm(BOARD_TMR3_PERIPHERAL, BOARD_TMR3_CHANNEL_0_CHANNEL, 348837UL, 10U, false, BOARD_TMR3_CHANNEL_0_CLOCK_SOURCE);
}
