...
//#define HOST_ECHO	//nsmoon@191021
//#define HOST_ECHO_DEBUG //nsmoon@211201
...
#define USB_HOST_CONFIG_CLASS_AUTO_CLEAR_STALL (0U) //nsmoon@190417
...
/*!
 * @brief host VENDOR class instance count, meantime it indicates VENDOR class enable or disable.
 *        - if 0, host VENDOR class driver is disable.
 *        - if greater than 0, host VENDOR class driver is enable.
 */
#define USB_HOST_CONFIG_VENDOR (1U)  //nsmoon@190130
