...
#define Coupling_Sig_TSPM()         TMR1_PERIPHERAL->CHANNEL[TMR1_CHANNEL_0_CHANNEL].CTRL = 0x30E4;
#define MCU_LED_CELL_EN_TSPM()      TMR2_PERIPHERAL->CHANNEL[TMR2_CHANNEL_3_CHANNEL].CTRL = 0x30E4;
#define MCU_AN_SW_EN1_TSPM()        TMR3_PERIPHERAL->CHANNEL[TMR3_CHANNEL_0_CHANNEL].CTRL = 0x30E4;
#define MCU_LED_GROUP_CLK_TSPM()    TMR4_PERIPHERAL->CHANNEL[TMR4_CHANNEL_3_CHANNEL].CTRL = 0x30E4;
...
#define M_TSPM_LED_Group_Clk_Wait(){\
       while((TMR4_PERIPHERAL->CHANNEL[TMR4_CHANNEL_3_CHANNEL].CTRL & 0xe000) >0){\
       }\
}
